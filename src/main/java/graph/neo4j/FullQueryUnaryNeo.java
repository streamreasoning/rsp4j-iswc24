...
public class FullQueryUnaryNeo implements RelationToRelationOperator<PGraphOrBindings> {
    ...
    @Override
    public PGraphOrBindings eval(List<PGraphOrBindings> datasets) {

        PGraphOrBindings dataset = datasets.get(0);
