package org.streamreasoning.sld.processing.neo4j.op;
...
public class FullQueryUnaryNeo implements RelationToRelationOperator<PGraphOrResult> {
    ...
    public PGraphOrResult eval(List<PGraphOrResult> datasets) {
        ...
        List<org.streamreasoning.sld.processing.neo4j.events.Result> res = new ArrayList<>();
        ...
        while (result.hasNext()) {
            ...
            res.add(new org.streamreasoning.sld.processing.neo4j.events.Result(next));
//        |name-->Fred
//        |age-->22
        }
        txe.commit();
