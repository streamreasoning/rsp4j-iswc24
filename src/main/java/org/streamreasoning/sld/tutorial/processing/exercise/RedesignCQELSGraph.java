...
public class RedesignCQELSGraph {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // We need to deal with the multiple-result fro each input graph
        AccumulatorContentFactoryFlat<Graph, Binding, List<Binding>> accumulatorContentFactory = null;

        StreamToRelationOperator<Graph, Binding, List<Binding>> s2rOp = null;
